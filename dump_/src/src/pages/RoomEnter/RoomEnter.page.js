...
const RoomEnterPage = ({ navigation }) => {
  ...
  const enterHistoryRoom = (room_number) => {
    dispatch(checkRoom({ room_number }));
  };
        ...
        <View style={styles.header_view}>
          <View style={styles.userInfo_view}>
            ...
            <View style={{ marginTop: 5, marginLeft: 5 }}>
              ...
              <Text style={styles.userInfo_text}>帐号: dong945</Text>
            </View>
          </View>
            ...
            {historyRooms.map((item, i) => {
              return (
                <View
                  ...
                  key={i}
                  onClick={() => enterHistoryRoom(item.room_number)}
                >
                  <View style={styles.history_room_card}>
                    <Image
                      source={`${IMG_URL}/RoomEnter/${item.img}`}
                      style={styles.histroy_room_bg}
                    />
                  </View>
                  <Text style={styles.history_room_num}>
                    {item.room_number}
                  </Text>
                </View>
              );

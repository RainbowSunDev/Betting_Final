...
export const checkSocketResponse = (response) => {
  switch (response.status) {
    ...
    case RES_STATUS_SERVER_ERROR:
      return {
        status: RES_MSG_SERVER_ERROR,
      };
    case RES_MSG_NOT_ENOUGH_POINT:
      return {
        status: RES_MSG_NOT_ENOUGH_POINT,
      };
  }
};

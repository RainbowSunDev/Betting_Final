                ...
                <View style={styles.edit_view}>
                    <View style={styles.edit_row_view}>
                        <View style={styles.edit_input_view}>
                            <TextInput style={[styles.edit_input, { outline: 'none' }]}
                                onChange={(e) => { setPassword(e.target.value) }} value={password}
                                secureTextEntry={viewFlag ? false : true} />
                        </View>
                        <View style={styles.view_btn_view} onClick={() => { setViewFlag(!viewFlag) }}>
                            <Image source={viewFlag ? ViewBtnBg : HideBtnBg} style={[styles.view_btn, { width: password.length ? 20 : 0 }]} />
                        </View>
                    </View>
                </View>

        ...
        <View style={styles.container}>
            ...
            <View style={{ paddingLeft: 5, paddingRight: 5, marginTop: 10 }}>
                <View style={styles.wallet_info_view}>
                    <View style={{ width: '33.3%', justifyContent: 'space-around', alignItems: 'flex-start' }}>
                        <Text style={{ fontSize: 16, color: 'white', marginLeft: 15, marginTop: 11 }}>总资产</Text>
                        <Text style={{ fontSize: 27, color: 'white', marginLeft: 15 }}>0.00</Text>
                        <Text style={{ fontSize: 16, color: 'white', marginLeft: 15, marginBottom: 15 }}>流水:0.0</Text>
                    </View>
                    <View style={{ width: '33.3%', justifyContent: 'flex-end', alignItems: 'flex-start' }}>
                        <Text style={{ fontSize: 16, color: 'white', marginLeft: 15, marginBottom: 13 }}>回水:0.0</Text>
                    </View>
                    <View style={{ width: '33.3%', justifyContent: 'space-around', alignItems: 'flex-start' }}>
                    ...
                    <View style={{
                        position: 'absolute', top: 5, right: 0, height: 22,
                        borderTopLeftRadius: 15, borderBottomLeftRadius: 15, borderTopRightRadius: 5, backgroundColor: '#79b3d9',
                ...
                <View style={styles.point_control_view}>
                    <TouchableOpacity style={styles.control_item_view} onPress={() => navigation.navigate('UpPoint')}>
                        <Image source={UpPointImg} style={styles.control_img} />
                        <Text style={styles.control_txt}>申请上分</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.control_item_view} onPress={() => navigation.navigate('DownPoint')}>
                        <Image source={DownPointImg} style={styles.control_img} />
                        <Text style={styles.control_txt}>申请下分</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.control_item_view} onPress={() => navigation.navigate('PaymentMethod')}>
            ...
            <View style={styles.lower_view}>
                <View style={styles.info_row}>
                    <TouchableOpacity style={[styles.info_item, { borderBottomWidth: 1, borderBottomColor: '#edeaea', borderRightWidth: 1, borderRightColor: '#edeaea' }]}
                    ...
                    <TouchableOpacity style={[styles.info_item, { borderBottomWidth: 1, borderBottomColor: '#edeaea' }]}
                ...
                <View style={styles.info_row}>
                    <TouchableOpacity style={[styles.info_item, { borderRightWidth: 1, borderRightColor: '#edeaea' }]}
